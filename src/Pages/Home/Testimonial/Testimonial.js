...
const Testimonial = () => {
    return (
        <div className='mt-10 mb-10'>
            ...
            <div className="carousel text-black text-center w-full">
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <section className="my-8  w-full text-black">
                        <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
                            ...
                            <p className="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl ">"Veniam quidem animi ea maxime odit fugiat architecto perferendis ipsum perspiciatis iusto, provident qui nam dolorum corporis."</p>
